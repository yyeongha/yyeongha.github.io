...
![unet](https://github.com/yyeongha/yyeongha.github.io/blob/main/assets/img/favicons/2024-08-26-unet/unet.gif?raw=true)
...
![cnn_filter](https://github.com/yyeongha/yyeongha.github.io/blob/main/assets/img/favicons/2024-08-26-unet/cnn_filter.gif?raw=true)
...
![pooling](https://github.com/yyeongha/yyeongha.github.io/blob/main/assets/img/favicons/2024-08-26-unet/pooling.gif?raw=true)
* max pooling: 각각의 필터 안의 최대값을 반환
* average pooling: 각각의 필터 안의 평균값을 반환

❓ Slidinig Window
윈도욱 사진 위를 이동하며 자른이미지들의 입력값을 모델로 통과한 결과값을 얻는 방법이다.
![slidingwindow](https://github.com/yyeongha/yyeongha.github.io/blob/main/assets/img/favicons/2024-08-26-unet/slidingwindow.gif?raw=true)
